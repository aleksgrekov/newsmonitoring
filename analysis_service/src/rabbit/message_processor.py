...
class MessageProcessor(IMessageProcessor):
    ...
    Attributes:
        _header (str): Название заголовка для хранения количества попыток.
        _max_retry (int): Максимальное количество повторных попыток обработки.
        _critical_count (int): Критический порог попыток перед отклонением.
