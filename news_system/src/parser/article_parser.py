...
class ArticleParser:
    ...
    def parse_article_page(self, url: str) -> Dict[str, str]:
        try:
            ...
            if raw_date:
                try:
                    pub_date = date_parser.parse(raw_date, ignoretz=True).isoformat()
    ...
    def parse_page(self, html_content: bytes) -> List[Dict[str, str]]:
        try:
    ...
    def __parse_cnn_container(self, container) -> Dict[str, str]:
        try:
